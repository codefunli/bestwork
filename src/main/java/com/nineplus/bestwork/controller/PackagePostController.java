...
public class PackagePostController extends BaseController {
	...
	public ResponseEntity<? extends Object> update(@RequestBody PackagePostReqDto packagePostReqDto,
			@PathVariable String airWayBillCode) throws BestWorkBussinessException {
		try {
			iPackagePostService.updatePackagePost(packagePostReqDto, airWayBillCode);
	...
	public ResponseEntity<? extends Object> getFile(
			@RequestParam(value = "packagePostId", required = true) Long packagePostId,
